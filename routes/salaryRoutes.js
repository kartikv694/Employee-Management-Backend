...
// add Salary API
// https://employee-management-backend-ten.vercel.app/api/v2/employee/salary/add
router.post("/add",addSalaryController)

// view Salary API
// https://employee-management-backend-ten.vercel.app/api/v2/employee/salary/view
router.get("/view",viewSalaryController)

// API FOR SHOWING OLD DATA FOR A PERTICULER EMPLOYEE SALARY
// https://employee-management-backend-ten.vercel.app/api/v2/employee/salary/salary/
