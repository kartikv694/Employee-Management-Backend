...
// APPLY LEAVE API
// https://employee-management-backend-ime7.onrender.com/api/v2/employee/leave/apply
router.post("/apply",isSignIn,applyLeaveController) 

// SHOW LEAVE API
// https://employee-management-backend-ime7.onrender.com/api/v2/employee/leave/all-leaves/
router.get("/all-leaves/:_id",isSignIn,showLeavesController)

// SHOW ALL EMPLOYEE LEAVES 
// https://employee-management-backend-ime7.onrender.com/api/v2/employee/leave/emp-leaves
router.get("/emp-leaves",isSignIn,getEmployeesLeavesController)

// SHOW LEAVE DETAILS
// https://employee-management-backend-ime7.onrender.com/api/v2/employee/leave/details/
router.get("/details/:_id",isSignIn,LeaveDetailController)

// STATUS OF LEAVE
// https://employee-management-backend-ime7.onrender.com/api/v2/employee/leave/status/
